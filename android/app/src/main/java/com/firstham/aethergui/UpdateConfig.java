...
final class UpdateConfig {
    static final String API_URL = "https://api.github.com/repos/DnsChangerPM/AetherGUI/releases?per_page=30";
    static final String LATEST_API_URL = "https://api.github.com/repos/DnsChangerPM/AetherGUI/releases/latest";
    static final String RELEASE_ASSET = "Aethon-VPN-v%s-Android-Universal.apk";
    static final String CHECKSUM_ASSET = "SHA256SUMS.txt";
    static final String RELEASE_DOWNLOAD_PREFIX = "https://github.com/DnsChangerPM/AetherGUI/releases/download/";
